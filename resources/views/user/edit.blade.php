...
<form class="form-horizontal" method="POST" action="{{ route('updateUser', $userList->id) }}"  enctype="multipart/form-data" >
            @csrf
<div class="form-group">
    <label class="control-label col-sm-2" for="firstname">@lang('messages.firstname')</label>
    <div class="col-sm-10">
      <input type="text" name="firstname" class="form-control" value="{{$userList->firstname}}" id="firstname" placeholder="@lang('messages.firstname')">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="lastname">@lang('messages.lastname')</label>
    <div class="col-sm-10">
      <input type="text" class="form-control"name="lastname" value="{{$userList->lastname}}" id="lastname" placeholder="@lang('messages.lastname')">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">@lang('messages.email')</label>
    <div class="col-sm-10">
      <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$userList->email}}" id="email" placeholder="Enter email">
...
@enderror
  ...
  <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                <select name="user_flg" class="form-control ">                              
                                                                @php
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="address" value="{{$userList->address}}" name="address" placeholder="@lang('messages.address')">
    </div>
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
     <textarea style="resize: none;" rows="7" cols="50" name="information"  class="ckeditor form-control" value="" class="form-control" placeholder="@lang('messages.information')">{{$userList->information}}</textarea>
    </div>
  </div>
